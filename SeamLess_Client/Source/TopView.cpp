...
void TopView::mouseDown(const juce::MouseEvent& e)
{
    ...
    if (e.getPosition().getX() < 145 && e.getPosition().getY() < 90)
        ...
        coordinatesLabel.setBounds(20, 20, 95, 40);
...
void TopView::setZPos(float newValue)
{
    zPos = newValue;
}
...
void TopView::showGrid(bool showGrid, bool xyzGrid) 
{
    ...
    {
        enableGrid = true;
        coordinatesLabel.setColour(juce::Label::backgroundColourId, juce::Colour(0x70ffffff));

...
LFOBox::LFOBox(SeamLess_ClientAudioProcessor& p, juce::AudioProcessorValueTreeState& apvts) :
    ...
    xDepthSlider(p, apvts, false, { 0, juce::MathConstants<float>::twoPi, false }, "xLfoDepth"),
    xPhaseSlider(p, apvts, false, { juce::MathConstants<float>::pi , juce::MathConstants<float>::pi, true }, "xLfoPhase"),
    xOffsetSlider(p, apvts, false, { juce::MathConstants<float>::pi , juce::MathConstants<float>::pi, true }, "xLfoOffset"),
    yRateSlider(p, apvts, false, { 0, 1, true }, "yLfoRate"),
    yDepthSlider(p, apvts, false, { 0, juce::MathConstants<float>::twoPi, false }, "yLfoDepth"),
    yPhaseSlider(p, apvts, false, { juce::MathConstants<float>::pi , juce::MathConstants<float>::pi, true }, "yLfoPhase"),
    yOffsetSlider(p, apvts, false, { juce::MathConstants<float>::pi , juce::MathConstants<float>::pi, true }, "yLfoOffset"),
    zRateSlider(p, apvts, false, { 0, 1, true }, "zLfoRate"),
    zDepthSlider(p, apvts, false, { 0, juce::MathConstants<float>::twoPi, false }, "zLfoDepth"),
    zPhaseSlider(p, apvts, false, { juce::MathConstants<float>::pi , juce::MathConstants<float>::pi, true }, "zLfoPhase"),
    zOffsetSlider(p, apvts, false, { juce::MathConstants<float>::pi , juce::MathConstants<float>::pi, true }, "zLfoOffset"),
    LFOStartButton(),
    LFONumberBox()
{
    for (int i = 0; i < 12; i++)
